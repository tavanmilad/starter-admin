                ...
                <div class="auth-inner row m-0">
                    ...
                    <div class="d-none d-lg-flex col-lg-8 align-items-center p-2">
                        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                class="img-fluid" src="{{ asset('') }}app-assets/images/pages/register-v2-dark.svg"
                                alt="Register V2" /></div>
                    </div>
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            <h2 class="card-title fw-bold mb-1">Daftar</h2>
                            <p class="card-text mb-2">Jadikan manajemen aplikasi Anda mudah dan menyenangkan!</p>
                            <form class="auth-register-form mt-2" action="{{ url('register') }}" method="POST">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" id="name" type="text"
                                        name="name" placeholder="John Doe" aria-describedby="name" autofocus="" tabindex="1"
                                        value="{{ old('name') }}" />
                                    @error('name')
                                ...
                                <div class="mb-1">
                                    ...
                                    <input class="form-control @error('username') is-invalid @enderror" id="username"
                                        type="text" name="username" placeholder="johndoe" aria-describedby="username"
                                        autofocus="" tabindex="2" value="{{ old('username') }}" />
                                    @error('username')
                                        <small class="invalid-feedback">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="mb-1">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" id="email" type="text"
                                        name="email" placeholder="example@mail.com" aria-describedby="email" tabindex="3"
                                        value="{{ old('email') }}" />
                                    @error('email')
                                        <small class="invalid-feedback">{{ $message }}</small>
                                    @enderror
                            ...
                            <p class="text-center mt-2"><span>Sudah memiliki akun?</span>
