        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user"><a class="dropdown-item"
                        ...
                        class="dropdown-item" href="app-email.html"><i class="me-50"
                    ...
                    <div class="dropdown-divider"></div><a class="dropdown-item" href="page-account-settings.html"><i
                            class="me-50" data-feather="settings"></i> Settings</a><a class="dropdown-item"
                        ...
                        href="page-auth-login-v2.html"><i class="me-50" data-feather="power"></i> Logout</a>
                </div>
            </li>
        </ul>
    </div>
